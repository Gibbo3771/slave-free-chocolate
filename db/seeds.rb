...
require_relative("./seeds/locations.rb")



aldi = Source.create(name:"Aldi", href:"https://www.aldi.co.uk/", stamps:[@fairtrade_stamp, @utz_stamp, @rainforest_stamp])
aloha_feels = Source.create(name:"Aloha Feels", href:"https://alohafeels.com/", stamps:[@fairtrade_stamp], locations:[@aloha_feels_loc])
alma_chocolate = Source.create(name:"Alma Chocolate", href:"http://www.almachocolate.com/", locations:[@alma_chocolate_loc])
...
amano = Source.create(name:"Amano Artisan Chocolate", href:"http://amanochocolate.com", locations:[@amano_loc])
askinosie = Source.create(name:"Askinosie Chocolate", href:"https://askinosie.com/", locations:[@askinosie_loc])
beach_chocolate_factory = Source.create(name:"Beach Chocolate Factory", href:"https://beachchocolatefactory.com/", locations:[@beach_chocolate_factory_loc])
belicious = Source.create(name:"Belicious", href:"https://belicious.ca/", stamps:[@rainforest_stamp], locations:[@belicious_loc])
black_mountain_chocolate = Source.create(name:"Black Mountain Chocolate", href:"https://www.blackmountainchocolate.com/", locations:[@black_mountain_chocolate_loc])
aacaoteca = Source.create(name:"Cacaoteca", href:"https://cacaoteca.com/", locations:[@aacaoteca_loc])
caribean_chocolate = Source.create(name:"Caribeans", href:"http://www.caribeanschocolate.com/", locations:[@caribean_chocolate_loc])
